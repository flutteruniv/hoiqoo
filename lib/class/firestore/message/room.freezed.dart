...
abstract class $RoomCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'last_send_at') DateTime lastSendAt});
}
...
class _$_Room implements _Room {
  const _$_Room(
      ...
      @JsonKey(name: 'last_send_at') required this.lastSendAt});
  ...
  @override
  String toString() {
    return 'Room(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, userId: $userId, enterpriseId: $enterpriseId, lastSendAt: $lastSendAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, createdAt, updatedAt, userId, enterpriseId, lastSendAt);
...
abstract class _Room implements Room {
  const factory _Room(
          ...
          @JsonKey(name: 'enterprise_id') required final int enterpriseId,
          @JsonKey(name: 'last_send_at') required final DateTime lastSendAt}) =
      _$_Room;
